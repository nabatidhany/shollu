...
const stats = [
  ...
  { icon: <BookOpen className="text-green-600" />, title: "Total Hafalan Disetor", value: "150 Ayat" },
  { icon: <Trophy className="text-green-600" />, title: "Peserta Paling Aktif", value: "Aisyah (10 ayat)" },
  { icon: <Percent className="text-green-600" />, title: "Tingkat Kehadiran", value: "85%" },
];

const barData = [
  { surat: "Al-Fatihah", peserta: 15 },
  { surat: "Al-Baqarah", peserta: 10 },
  { surat: "Ali Imran", peserta: 8 },
];
...
const tableData = [
  { id: 1, name: "Ahmad", hadir: "✅", hafalan: "5 Ayat", surah: "Al-Baqarah 1-5" },
  { id: 2, name: "Aisyah", hadir: "✅", hafalan: "10 Ayat", surah: "Al-Baqarah 6-15" },
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="p-4">
          <CardHeader>
            <CardTitle className="text-center">Bacaan Per Surat</CardTitle>
          </CardHeader>
          <CardContent>
